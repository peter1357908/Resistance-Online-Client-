...
const MissionFailedModal = (props) => {
    ...
    <div className={showClassName}>
      <div className={props.classes.content}>
        ...
        <div className={props.classes.info}>
          <div className="missionOutcome">The mission FAILED</div>
          <div className="failedVotesReport">(fail votes: {props.numFailVotes})</div>
        </div>
      </div>
    </div>
  );
...
export default withStyles(useStyles)(MissionFailedModal);
